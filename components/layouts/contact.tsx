          ...
          <div className="glass-card rounded-3xl p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <button
                ...
                className="w-full btn-primary py-4 px-6 rounded-full font-semibold focus:ring-2 focus:ring-offset-2 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed text-sm"
              >
